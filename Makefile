...
# vpacreation.com/vpa-creation-operator-bundle:$VERSION and vpacreation.com/vpa-creation-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= vpacreation.com/vpa-creation-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name vpa-creation-operator-builder
	$(CONTAINER_TOOL) buildx use vpa-creation-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm vpa-creation-operator-builder
	rm Dockerfile.cross
